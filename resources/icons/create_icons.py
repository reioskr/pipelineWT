...
def convert_image_to_icon():
    ...
    # Construct the paths
    import_file = os.path.join(script_dir, 'fullsize.jpg')
    export_file = os.path.join(script_dir, 'app.ico')
    export_base64 = os.path.join(script_dir, '64px.ico')
    icon_base64_file = os.path.join(script_dir, 'icon_base64.py')
